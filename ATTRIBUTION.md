...
| ux-designer-skill | **Szilárd Hajba (szilu)** — github.com/szilu/ux-designer-skill (MIT, LICENSE included) |
...
| loop-contract, skill-stocktake | in-house (sanitized for sharing) |

## What was deliberately left out

Operational skills tied to a specific business (client reporting, fleet
monitoring, meeting sync, agent-architecture audit) are **not** in this bundle —
they encode client rosters, vault layouts and app inventories that are
meaningless (and private) outside the machine they were built for.
